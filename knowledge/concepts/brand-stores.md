...
id: brand-stores
title: Brand Stores
description: Dedicated brand destinations on Amazon that showcase product catalogs and support brand storytelling.
type: concept
status: active
created: 2026-08-12
updated: 2026-08-13
...
Brand Stores are dedicated multi-page destinations on Amazon that showcase a brand's full product catalog and support brand storytelling and engagement.
...
- [Sponsored Brands](/concepts/sponsored-brands.md): campaigns drive traffic to Brand Stores.
- [New-to-brand metrics](/concepts/new-to-brand-metrics.md): measure first-time customer acquisition from campaigns.
- [Advertising eligibility](/concepts/advertising-eligibility.md): Brand Registry requirements for access.
